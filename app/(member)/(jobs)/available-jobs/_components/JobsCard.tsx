    ...
    <div className="sm:hidden grid gap-4">
              ...
              <div className="px-6">
                ...
                <div className="mt-2 mb-3">
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Progress: {job._count.applicants}/{job.noOfWorkers}{" "}
                    applicants
                  </p>
      ...
      {!hasNext && jobs.length > 0 && (
        <div className="relative mx-auto w-full rounded-lg border border-dashed border-gray-300 px-4 sm:px-6 md:px-8 dark:border-gray-700">
          ...
          <div className="absolute bottom-4 left-0 z-0 h-px w-full bg-gray-400 sm:bottom-6 md:top-8 dark:bg-gray-600" />
