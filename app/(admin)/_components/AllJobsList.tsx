...
import { GetAllJobsType } from "@/app/data/admin/job/get-all-jobs";
import { loadMoreAllJobs } from "@/app/data/admin/job/load-more-all-jobs";

interface Props {
  initialJobs: GetAllJobsType[];
...
export function AllJobsList({
  ...
  const [jobs, setJobs] = useState<GetAllJobsType[]>(initialJobs);
  ...
  const loadMore = useCallback(async () => {
    ...
    try {
      ...
      const result = await loadMoreAllJobs(nextPage, query);
