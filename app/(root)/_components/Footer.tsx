...
export const Footer = () => {
	...
	return (
		<footer className="bg-[#040403] text-white py-12">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					<div className="space-y-2 flex flex-col items-start">
						...
						<p className="text-base text-gray-200">
							Join our newsletter to get early access to tasks,
							exclusive offers, platform updates, and tips to earn
							smarter. No spam — just value, straight to your
							inbox.
						</p>
					</div>
					<NewsLetterForm />
